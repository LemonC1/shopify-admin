      ...
      <PageHeaderWrapper
        ...
        content={
          <div style={{ display: 'flex', alignItems: 'center', color: 'black' }}>
            ...
            <Badge
              style={{ margin: '0 10px' }}
              status={list.financial_status == 'paid' ? 'success' : 'processing'}
              text={list.financial_status}
      ...
      >
        <div style={{ display: 'flex' }}>
          <div style={{ flex: 7 }}>
            {/* fulfill */}
            {list.length != 0 && (
              <Card bordered={true} style={{ margin: '0 20px' }}>
                <div style={{ marginBottom: '10px' }}>
                  <Icon
                    style={{ fontSize: '30px', margin: ' 5px 10px 0 0' }}
                    type="check-circle"
                    theme="twoTone"
                ...
                >
                  <Badge count={list.line_items[0].quantity} style={{ backgroundColor: '#ccc' }}>
                    <img
                      style={{ width: '70px', flex: 1, display: 'block' }}
                      src={src == null ? noimg : src}
                    />
                  </Badge>
                  ...
                  <div style={{ flex: 3, color: 'black' }}>
                    ${list.line_items[0].price} <span style={{ padding: '0 20px' }}>x</span>{' '}
                ...
                <div style={{ textAlign: 'right', paddingTop: '20px' }}>
                  <Button
                    size="large"
                    type="primary"
                    onClick={this.changefulfill.bind(
                      this,
            ...
            {/* paid_status */}
            {list.length != 0 && (
              <Card bordered={true} style={{ margin: '20px 20px 0', color: 'black' }}>
                <div>
                  <Icon
                    style={{ fontSize: '30px', margin: ' 5px 10px 25px 0' }}
                    type="check-circle"
                    theme="twoTone"
                    twoToneColor={list.financial_status == 'paid' ? '#52c41a' : '#ccc'}
                  />
                  <span style={{ fontSize: '18px', color: 'black' }}>
                    {list.financial_status == 'paid' ? 'Paid' : 'Payment pending'}{' '}
                  </span>
                </div>
                ...
                <div
                  style={{
                    textAlign: 'right',
                    paddingTop: '20px',
                    display: list.financial_status == 'paid' ? 'none' : 'block',
                  }}
                >
              ...
              <Card bordered={true} style={{ marginBottom: '20px' }}>
                <div>
                  ...
                  {this.state.loading ? (
                    ...
                    <span>{list.note == '' ? 'No notes from customer' : list.note}</span>
                  )}
                </div>
              </Card>
            )}
